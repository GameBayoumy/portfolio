...
interface ArtisticBackgroundProps {
  ...
  colorScheme?: 'aurora' | 'ocean' | 'nebula' | 'sunset' | 'cosmic' | 'ethereal'
...
export function ArtisticBackground({
  ...
  const shaderMaterial = useMemo(() => {
    ...
    distortionStrength, elevation, glowIntensity, contrastBoost,
    saturationBoost, brightnessBoost, ambientStrength, specularStrength,
    shininess, fresnelStrength, depthFade, edgeGlow, holographicEffect,
    performanceSettings
  ])
